...
$plugin = plugin_basename(__FILE__); 
add_filter("plugin_action_links_$plugin", 'utf8ize_settings_link' );
...
<a class="nav-tab<?php if($selected_tab=='generator')echo' nav-tab-active';?>" href="tools.php?page=utf8ize/utf8ize.php&tab=generator">SQL generator</a>
<a class="nav-tab<?php if($selected_tab=='documentation')echo' nav-tab-active';?>" href="tools.php?page=utf8ize/utf8ize.php&tab=documentation">Documentation</a>
</h2>




<?php if ( $selected_tab == 'generator' ) { ?>
...
<h3><span style="color:red;"><strong>!!! CAUTION !!!</strong><br />
The execution time of the next SQL statements may take a lot of time(even days), 
related to dimensions of your database and the amount of the content.
</span></h3>
...
<?php if ( $selected_tab == 'documentation' ) { ?>
...
<p>
In the examples below it is assumed you have a database in the latin1 character set that needs converting to a utf8 character set. latin1 is the tragic default of MySQL and the most likely to be the problematic format of older copies of WordPress. UFT8 is the best way to support all internet-friendly languages. 
</p>
...
function utf8ize_menu() {
	add_management_page(
		'Utf8ize - Options', //'custom menu title', 
		'Utf8ize', //'custom menu', 
